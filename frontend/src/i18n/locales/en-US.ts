...
\
  ...
  tools: {
    ...
    think: 'Deep Thinking',
    todoWrite: 'Make Plan',
    // Tool management page (first-class)
    pageDesc: 'Manage tool libraries and custom HTTP tools, bindable to agents.',
    libraries: 'Tool Libraries',
    librariesHint: 'Each library groups a set of tools. Built-in library holds system presets; custom libraries hold your HTTP tools.',
    builtin: 'Built-in',
    noDesc: 'No description',
    toolsUnit: 'tools',
    actions: 'Actions',
    createLibrary: 'New Library',
    createLibraryHint: 'Create a new tool library to organize your HTTP tools',
    emptyLibraries: 'No libraries yet — click the card above to create one',
    manageHint: 'Manage custom tools in this library',
    createTool: 'New Tool',
    backToLibraries: 'Back to libraries',
    emptyTools: 'No tools in this library yet',
    ...
    libraryName: 'Tool Library Name',
    libraryNamePlaceholder: 'e.g. ops-tools',
    libraryDesc: 'Tool Library Description',
    editor: {
      createTitle: 'New Custom Tool',
      editTitle: 'Edit Custom Tool',
      name: 'Tool Name',
      namePlaceholder: 'e.g. http_search_jira',
      nameHelp: 'Starts with lowercase, lowercase letters/digits/underscores, 3-63 chars; immutable after save',
      displayName: 'Display Name',
      displayNamePlaceholder: 'Human-friendly name (optional)',
      description: 'Description',
      httpSection: 'HTTP Config',
      method: 'Method',
      urlTemplate: 'URL Template',
      headers: 'Headers',
      addHeader: 'Add Header',
      bodyTemplate: 'Body Template',
      bodyHelp: 'JSON; reference params with {\'{var}\'}, e.g. {\'{"q": "{query}"}\'}',
      authSection: 'Auth',
      authType: 'Auth Type',
      authHeader: 'Header Name',
      basicToken: 'user:pass',
      token: 'Token',
      tokenKept: 'Configured (leave blank to keep)',
      tokenPlaceholder: 'Enter token',
      tokenKeepHint: 'Leaving blank keeps the stored token on the server',
      advancedSection: 'Advanced',
      parametersSchema: 'Parameters Schema',
      schemaHelp: 'JSON Schema describing tool inputs, fed to the LLM',
      responseExtract: 'Response Extract',
      timeout: 'Timeout (s)',
      requireApproval: 'Require approval',
      requireApprovalHelp: 'When enabled, calling this tool requires user confirmation in chat',
      enabled: 'Enabled',
      testTitle: 'Test Invocation',
      testBtn: 'Test',
      testArgsPlaceholder: 'Args JSON, e.g. {\'{"query": "hello"}\'}',
    },
  },
  vectorStoreBadge: {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync uploaded files (PDF/Word/Excel) from DingTalk knowledge bases (online docs not yet supported)',
    ...
    field: {
      ...
      userIdHint: 'DingTalk document APIs require an operator identity. Enter a staff userid from the corporate contact; it is resolved to a unionId used as the operator. The user must have read access to the docs you sync. You can find the userid in the DingTalk admin console under Contacts.',
  ...
  integrations: {
    ...
    api: {
      ...
      playgroundTenantModeHint: 'Tenant-only mode does not send an external user identity; all API sessions use the same tenant-level principal.',
      ...
      playgroundStop: 'Stop',
      playgroundNeedApiKey: 'This tenant has no API key.',
