export default {
  ...
  tools: {
    ...
    todoWrite: "制定计划",
    // 工具管理页（一等公民）
    pageDesc: "管理工具库与自定义 HTTP 工具，可绑定到智能体使用。",
    libraries: "工具库",
    librariesHint: "每个工具库是一组工具的集合；内置库包含系统预置工具，自定义库可添加 HTTP 工具。",
    builtin: "内置",
    noDesc: "暂无描述",
    toolsUnit: "个工具",
    actions: "操作",
    createLibrary: "新建工具库",
    createLibraryHint: "创建一个新的工具库来组织你的 HTTP 工具",
    emptyLibraries: "暂无工具库，点击上方卡片创建",
    manageHint: "管理此库下的自定义工具",
    createTool: "新建工具",
    backToLibraries: "返回工具库列表",
    emptyTools: "此库下暂无工具",
    requireApproval: "需审批",
    enabled: "已启用",
    disabled: "已停用",
    ...
    edit: "编辑",
    delete: "删除",
    deleteConfirm: "确定删除此工具？",
    editLibrary: "编辑工具库",
    libraryName: "工具库名称",
    libraryNamePlaceholder: "例如：运维工具集",
    libraryDesc: "工具库描述",
    editor: {
      createTitle: "新建自定义工具",
      editTitle: "编辑自定义工具",
      name: "工具名称",
      namePlaceholder: "例如：http_search_jira",
      nameHelp: "小写字母开头，仅含小写字母/数字/下划线，3-63 字符；保存后不可修改",
      displayName: "显示名称",
      displayNamePlaceholder: "展示给用户的中文名（可选）",
      description: "工具描述",
      httpSection: "HTTP 配置",
      method: "方法",
      urlTemplate: "URL 模板",
      ...
      addHeader: "添加请求头",
      bodyTemplate: "请求体模板",
      bodyHelp: 'JSON 格式，用 {\'{var}\'} 引用参数，如 {\'{"q": "{query}"}\'}',
      authSection: "鉴权",
      authType: "鉴权方式",
      authHeader: "Header 名",
      basicToken: "user:pass",
      token: "Token",
      tokenKept: "已配置（留空保持不变）",
      tokenPlaceholder: "输入 Token",
      tokenKeepHint: "留空将保留服务端已存储的 Token",
      advancedSection: "高级",
      parametersSchema: "参数 Schema",
      schemaHelp: "JSON Schema 格式，描述工具入参，喂给 LLM",
      responseExtract: "响应提取",
      timeout: "超时(秒)",
      requireApproval: "需要人工审批",
      requireApprovalHelp: "开启后，调用此工具时需用户在对话中确认",
      enabled: "启用",
      testTitle: "测试调用",
      testBtn: "测试",
      testArgsPlaceholder: '入参 JSON，如 {\'{"query": "hello"}\'}',
    },
  },
  vectorStoreBadge: {
    systemDefault: "系统默认",
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      yuque: "同步语雀知识库中的文档",
      dingtalk: "同步钉钉知识库中上传的文件（PDF/Word/Excel 等，暂不支持在线文档）",
    ...
    field: {
      ...
      userId: "操作员 User ID",
      userIdHint: "钉钉文档 API 需要操作员身份。填写一个在企业通讯录中的员工 userid，用于换取 unionId 作为操作员。该用户需对要同步的文档有阅读权限。可在钉钉管理后台「通讯录」中查看员工 userid。",
  ...
  integrations: {
    ...
    api: {
      ...
      principalScope:
        "按终端用户隔离对话 Session 与 MCP 工具授权（OAuth）；API Key 仍可访问租户内全部知识库等资源，权限范围不按外部用户拆分。",
      modeTenant: "仅租户",
      modeDirect: "直接传用户 ID",
      modeSigned: "签名 Token",
