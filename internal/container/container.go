...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(repository.NewToolLibraryRepository))
	must(container.Provide(repository.NewCustomToolRepository))
	...
	must(container.Provide(service.NewToolService))
	...
	must(container.Provide(handler.NewToolHandler))
